<p>
    ...
    This EULA agreement governs your acquisition and use of our SavorGame application ("Application") directly from
    SavorGame or indirectly through a SavorGame authorized reseller or distributor (a "Reseller").

    Please read this EULA agreement carefully before completing the installation process and using the SavorGame
    application.
    It provides a license to use the SavorGame application and contains warranty information and liability disclaimers.

    If you register for a free trial of the SavorGame application, this EULA agreement will also govern that trial. By
    clicking "accept" or installing and/or using the SavorGame application, you are confirming your acceptance of the
    Software
    ...
    This EULA agreement shall apply only to the Software supplied by SavorGame herewith regardless of whether other
    software is referred to or described herein. The terms also apply to any SavorGame updates, supplements,
    ...
    License Grant
    SavorGame hereby grants you a personal, non-transferable, non-exclusive licence to use the SavorGame application on
    your devices in accordance with the terms of this EULA agreement.

    You are permitted to load the SavorGame application (for example a PC, laptop, mobile or tablet) under your control.
    You are responsible for ensuring your device meets the minimum requirements of the SavorGame application.
    ...
    SavorGame shall at all times retain ownership of the Software as originally downloaded by you and all subsequent
    downloads of the Software by you. The Software (and the copyright, and other intellectual property rights of
    whatever nature in the Software, including any modifications made thereto) are and shall remain the property of My
    Company.

    SavorGame reserves the right to grant licences to use the Software to third parties.

    Termination
    This EULA agreement is effective from the date you first use the Software and shall continue until terminated. You
    ...
    termination, the licenses granted by this EULA agreement will immediately terminate and you agree to stop all access
    and use of the Software. The provisions that by their nature continue and survive will survive any termination of
    this EULA agreement.

    Governing Law
    This EULA agreement, and any dispute arising out of or in connection with this EULA agreement, shall be governed by
    and construed in accordance with the laws of My Country.
</p>